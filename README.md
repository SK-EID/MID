...
*   [4\. Helper libraries and demo applications](#4-helper-libraries-and-demo-applications)
    ...
    *   [4.2\. PHP](#42-php)
*   [5\. OCSP](#5-ocsp)
    *   [5.1\. OSCP Necessity](#51-ocsp-necessity)
    *   [5.2\. Implementing OCSP](#52-implementing-ocsp)
<div>  
...
See also certificate owner´s personal data structure overview that is located on the certificate´s Subject field: https://github.com/SK-EID/MID/wiki/Test-number-for-automated-testing-in-DEMO#personal-data-structure-overview-that-is-located-on-the-certificates-subject-field
